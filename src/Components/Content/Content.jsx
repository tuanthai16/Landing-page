...
const Content = () => {
  const customer = useSpring({ customers: 50, from: { customers: 0 } });
  const card = useSpring({ cards: 20, from: { cards: 0 } });
  return (
      ...
      <div className="ml-[70px] mr-[54px] text-bold flex flex-col items-center bg-gradient-to-b shadow-md from-white/40 rounded-[24px] to-transparent md:w-[20%]">
        <div className="mt-16 gap-8 flex items-start">
          ...
          <div className="text-26">
            ...
            <p className="text-13 font-semibold mb-[36px] md:text-16">Join</p>
          </div>
        </div>
        <div className="gap-8 flex items-start mb-16">
          ...
          <div className="text-26">
            ...
            <p className="text-13 font-semibold md:text-16"> Paid </p>
          </div>
        </div>
      </div>
